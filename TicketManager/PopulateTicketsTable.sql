...
INSERT INTO tickets (Name, FromUser, ToUser, Priority, Department, Category, Date, State, Description)
	VALUES ('Recruit new talent', 'cosmin', 'vasile', 3, 'Human_Resources', 'Story', '20130601 10:34:15 AM', 'Started', 'We could increase the number of our employees by searching and recruiting university students for summer internships.');
